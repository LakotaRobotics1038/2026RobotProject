...
public final class VisionConstants {
    ...
    private static final double LEFT_CAMERA_Z_OFFSET = Units.inchesToMeters(7.729); // TODO I think this is from the bottom of the robot, not the floor. That might not be correct. I honestly don't know.
    public static final Transform3d ROBOT_TO_LEFT_CAM = new Transform3d(
            ...
            new Rotation3d(0, Math.toRadians(-90), Math.toRadians(180 - 75)));
    ...
    private static final double RIGHT_CAMERA_Y_OFFSET = Units.inchesToMeters(11.961);
    private static final double RIGHT_CAMERA_Z_OFFSET = Units.inchesToMeters(8.191);
