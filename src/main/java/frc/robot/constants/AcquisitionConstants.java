...
public final class AcquisitionConstants {
    ...
    public static final double INTAKE_P = 0.1; // Acquire is 0.1
    ...
    public static final double INTAKE_ACQUIRE_RPM = 4000; // Acquire is 4000
    public static final double INTAKE_SLOW_ACQUIRE_RPM = 500;
